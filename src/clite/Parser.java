...
public class Parser {
    ...
    private Type type () {
        // Type  -->  int | bool | float | double | char 
        Type t = null;
	if (token.type().equals(TokenType.Int)) {
		...
		t = Type.FLOAT;
	} else if (token.type().equals(TokenType.Double)) { // New Type DOUBLE
		t = Type.DOUBLE;
	} else if (token.type().equals(TokenType.Void)) {
		t = Type.VOID;
	} else error("int | bool | float | double| char");
        // student exercise
        return t;          
    }
    ...
    private boolean isType( ) {
        return token.type().equals(TokenType.Int)
			...
			|| token.type().equals(TokenType.Double)  // New Type DOUBLE
    ...
    private boolean isLiteral( ) {
        return token.type().equals(TokenType.IntLiteral) ||
			...
			token.type().equals(TokenType.DoubleLiteral) ||  // New Type DOUBLE
